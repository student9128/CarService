package com.kevin.carservice.dialog;
...
public class BaseDialog extends DialogFragment {
    ...
    public void setOnDialogBtnClickListener(DialogContract.DialogBtnClickListener listener) {
        btnClickListener = listener;
    }

    public void setOnDialogDismissListener(DialogContract.DialogDismissListener listener) {
